...
const router= createBrowserRouter([
  
  {
    ...
    children:[
      ...
      {path: '/Produtos/EditarProduto', element: <EditarProduto/>},
      {path: '/Pedido/EditarPedido', element: <EditarPedido/>},
      {path: '/Produtos/ExcluirProduto', element: <ExcluirProduto/>},
      {path: '/Pedido/ExcluirPedido', element: <ExcluirPedido/>},
